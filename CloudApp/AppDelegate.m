...
//    _mainTabController=[[MainTabBarViewController alloc]init];
//    
//    
...
//    [self.window makeKeyAndVisible];
    ...
    if ([userDefaults boolForKey:User_IsLogined]) {
        [[AppDelegate sharedOCCommunication] setCredentialsWithUser:[userDefaults objectForKey:User_UserName] andPassword:[userDefaults objectForKey:User_UserPassword]];
...
//                                               object: nil];
//    Reachability * hostReach = [Reachability reachabilityWithHostName:@"www.baidu.com"];//可以以多种形式初始化
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CloudApp" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CloudApp.sqlite"];
